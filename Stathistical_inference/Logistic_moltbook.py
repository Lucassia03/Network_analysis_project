...
SELECT
    ...
    c.comment_post_neutral_score,
    c.comment_post_entailment_score,
    c.comment_post_contradiction_score,
...
WHERE c.final_sycophancy_likelihood IS NOT NULL
  ...
  AND c.comment_post_neutral_score IS NOT NULL
  AND c.comment_post_entailment_score IS NOT NULL
  AND c.comment_post_contradiction_score IS NOT NULL
...
print("\nNLI neutral score summary:")
print(df["comment_post_neutral_score"].describe())

print("\nNLI entailment score summary:")
print(df["comment_post_entailment_score"].describe())

print("\nNLI contradiction score summary:")
print(df["comment_post_contradiction_score"].describe())
...
features_without_previous_interaction = [
    "comment_post_neutral_score",
    "comment_post_entailment_score",
    "comment_post_contradiction_score",
    "agent_model"
]
...
model_likelihood_1 = fit_sklearn_linear_model(
    ...
    model_name="A: NLI likelihood, no previous interaction"
)

print("\n\n=====================================================")
print("REGRESSION A")
print("Target: final_sycophancy_likelihood")
print("Predictors: NLI scores + agent model")
print("=====================================================")
...
model_likelihood_2 = fit_sklearn_linear_model(
    ...
    target_col="final_sycophancy_likelihood",
    model_name="B: NLI likelihood, with previous interaction"
)

print("\n\n=====================================================")
print("REGRESSION B")
print("Target: final_sycophancy_likelihood")
print("Predictors: NLI scores + agent model + previous interaction")
print("=====================================================")
...
model_keyword_1 = fit_sklearn_linear_model(
    ...
    model_name="C: NLI keyword count, no previous interaction"
)
...
model_keyword_2 = fit_sklearn_linear_model(
    ...
    feature_cols=features_with_previous_interaction,
    target_col="sycophancy_keyword_count",
    model_name="D: NLI keyword count, with previous interaction"
)
...
excel_path = output_folder + r"\sycophancy_nli_sklearn_regression_results.xlsx"
